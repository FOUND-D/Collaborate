...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> with SafeLoadMixin {
  ...
  Future<void> _load() async {
    ...
    await safeLoad(() async {
      ...
      final topSkills = await api.getAdminTopSkills();
      if (mounted) setState(() => _topSkills = topSkills);
    });
