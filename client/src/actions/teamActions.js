...
export const createTeam = ({ name, organisation = null, type = 'study_group', subjectCode = '' }) => async (dispatch, getState) => {
  try {
    dispatch({
    ...
    const payload = organisation ? { name, organisation, type, subjectCode } : { name, type, subjectCode };
