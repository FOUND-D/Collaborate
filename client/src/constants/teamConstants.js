...
export const TEAM_JOIN_RESET = 'TEAM_JOIN_RESET';

export const TEAM_UPDATE_JOIN_REQUEST_REQUEST = 'TEAM_UPDATE_JOIN_REQUEST_REQUEST';
export const TEAM_UPDATE_JOIN_REQUEST_SUCCESS = 'TEAM_UPDATE_JOIN_REQUEST_SUCCESS';
export const TEAM_UPDATE_JOIN_REQUEST_FAIL = 'TEAM_UPDATE_JOIN_REQUEST_FAIL';
export const TEAM_UPDATE_JOIN_REQUEST_RESET = 'TEAM_UPDATE_JOIN_REQUEST_RESET';
