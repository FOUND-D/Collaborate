...
export const RESOURCE_SUMMARISE_REQUEST = 'RESOURCE_SUMMARISE_REQUEST';
export const RESOURCE_SUMMARISE_SUCCESS = 'RESOURCE_SUMMARISE_SUCCESS';
export const RESOURCE_SUMMARISE_FAIL = 'RESOURCE_SUMMARISE_FAIL';
...
export const RESOURCE_PIN_REQUEST = 'RESOURCE_PIN_REQUEST';
export const RESOURCE_PIN_SUCCESS = 'RESOURCE_PIN_SUCCESS';
export const RESOURCE_PIN_FAIL = 'RESOURCE_PIN_FAIL';
